...
def get_gemini_client():
    """Lazily initialize the Gemini client so offline/fallback execution is possible."""
    global _client
    ...
    try:
        ...
        raise RuntimeError(
            "google-genai is not installed. Please install google-genai to use Gemini models."
        ) from exc
